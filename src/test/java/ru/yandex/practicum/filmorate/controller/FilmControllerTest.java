...
class FilmControllerTest {
    ...
    @Test
    void create() {
        Film film = Film.builder().name("name").rate(1).description("description").duration(100).releaseDate(LocalDate.of(2020, 1, 1)).build();
    ...
    void createWithNullName() {
        final NullPointerException exception = assertThrows(NullPointerException.class, () -> {
            Film film = Film.builder().rate(1).description("description").duration(100).releaseDate(LocalDate.of(2020, 1, 1)).build();
        });
    }

    @Test
    void createWithEmptyName() {
        Film film = Film.builder().name("").rate(1).description("description").duration(100).releaseDate(LocalDate.of(2020, 1, 1)).build();
    ...
    void createWithDescription200Name() {
        Film film = Film.builder().name("name").rate(1).description("*".repeat(200)).duration(100).releaseDate(LocalDate.of(2020, 1, 1)).build();
    ...
    void createWithDescriptionMore200Name() {
        Film film = Film.builder().name("name").rate(1).description("*".repeat(201)).duration(100).releaseDate(LocalDate.of(2020, 1, 1)).build();
        final ValidationException exception = assertThrows(ValidationException.class, () -> {
            filmController.create(film);
        });
    }
    ...
    void createWithIncorrectReleaseDate() {
        Film film = Film.builder().name("name").rate(1).description("description").duration(100).releaseDate(LocalDate.of(1895, 12, 28).minusDays(1)).build();
        final ValidationException exception = assertThrows(ValidationException.class, () -> {
            filmController.create(film);
        });
    }
    ...
    void createWithCorrectReleaseDate() {
        Film film = Film.builder().name("name").rate(1).description("description").duration(100).releaseDate(LocalDate.of(1895, 12, 28)).build();
        filmController.create(film);
    }

    @Test
    void createWithCorrectDuration0() {
        Film film = Film.builder().name("name").rate(1).description("description").duration(0).releaseDate(LocalDate.of(2000, 12, 28)).build();
        final ValidationException exception = assertThrows(ValidationException.class, () -> {
            filmController.create(film);
        });
    }
    ...
    void createWithCorrectDurationNegative() {
        Film film = Film.builder().name("name").rate(1).description("description").duration(-100).releaseDate(LocalDate.of(2000, 12, 28)).build();
        final ValidationException exception = assertThrows(ValidationException.class, () -> {
            filmController.create(film);
        });
    }
    ...
    public void getAll() {
        Film film = Film.builder().name("name").rate(1).description("description").duration(100).releaseDate(LocalDate.of(2000, 12, 28)).build();
        filmController.create(film);
        Film film2 = Film.builder().name("name2").rate(2).description("description2").duration(200).releaseDate(LocalDate.of(2002, 12, 28)).build();
